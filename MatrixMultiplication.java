...
class MatrixMultiplication {
    public static void main(String args[]){
        ...
        int b[][] = new int[r2][c2];
        if(r1 != c2){
            System.out.println("Matrix Multiplication not possible as order of matrices doesnot match");
            System.exit(0);
        }
        else{
            ...
            System.out.println("After multiplication the resulatant matrix is:");
            for(int i=0; i<r1; i++){
                for(int j=0; j<c2; j++){
